...
import { MANIPULATOR_VISUAL_SCALE, SILO_VISUAL_SCALE, SILO_Y_OFFSET, LAB_VISUAL_SCALE, SPLITTER_VISUAL_SCALE, ASSEMBLER_VISUAL_SCALE } from './machines';
...
export function initInput(canvas: HTMLCanvasElement, viewport: Viewport, layers: GameLayers): void {
  ...
  const updateGroupGhost = (blueprintId: string) => {
    ...
    instantiated.forEach((e, i) => {
      ...
      sprite.scale.set(
        e.kind === 'manipulator' ? MANIPULATOR_VISUAL_SCALE : e.kind === 'splitter' ? SPLITTER_VISUAL_SCALE : e.kind === 'assembler' ? ASSEMBLER_VISUAL_SCALE : e.kind === 'lab' ? LAB_VISUAL_SCALE : 1,
        e.kind === 'manipulator' ? -MANIPULATOR_VISUAL_SCALE : e.kind === 'splitter' ? SPLITTER_VISUAL_SCALE : e.kind === 'assembler' ? ASSEMBLER_VISUAL_SCALE : e.kind === 'lab' ? LAB_VISUAL_SCALE : 1
      );
  ...
  const updateGhost = () => {
    ...
    ghostSprite.scale.set(
      tool === 'manipulator' ? MANIPULATOR_VISUAL_SCALE : tool === 'silo' ? SILO_VISUAL_SCALE : tool === 'splitter' ? SPLITTER_VISUAL_SCALE : tool === 'assembler' ? ASSEMBLER_VISUAL_SCALE : tool === 'lab' ? LAB_VISUAL_SCALE : 1,
      tool === 'manipulator' ? -MANIPULATOR_VISUAL_SCALE : tool === 'silo' ? SILO_VISUAL_SCALE : tool === 'splitter' ? SPLITTER_VISUAL_SCALE : tool === 'assembler' ? ASSEMBLER_VISUAL_SCALE : tool === 'lab' ? LAB_VISUAL_SCALE : 1
    );
