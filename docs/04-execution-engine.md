...
- Питание на этом этапе глобальное: аккумулятор есть и заряжен → все станки запитаны.

**E4 — энергостолбы (визуал ЛЭП, поверх стабильного E1):**
- Столб (`pole`, 1×1) соединяется проводом с аккумулятором или другим столбом в радиусе 6 тайлов; связность — BFS от аккумуляторов при каждом изменении поля. Провода рисует рендер (docs/02).
- Станок запитан, если попадает в покрытие 5×5 связанного столба или самого аккумулятора; вне линии → «Нет питания», как выше.
